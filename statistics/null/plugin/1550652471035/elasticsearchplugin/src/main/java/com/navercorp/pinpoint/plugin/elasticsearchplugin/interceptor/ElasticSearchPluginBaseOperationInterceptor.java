 ...
 * @author yinbp
 */
public abstract class ElasticSearchPluginBaseOperationInterceptor  implements AroundInterceptor {
    ...
    protected ElasticSearchPluginBaseOperationInterceptor(TraceContext traceContext, MethodDescriptor descriptor) {
